...
def load_training_data(full_G, training_G, structural_emb_dict, content_emb_dict, num_of_test_edges, reset_X):
    """
    ...
    """
    if os.path.exists(os.path.abspath('../data/link_prediction/data/X.txt')) and not reset_X:
        print('\nTraining graph found, loading X and y...')
        X = np.loadtxt(os.path.abspath('../data/link_prediction/data/X.txt'))
        y = np.loadtxt(os.path.abspath('../data/link_prediction/data/y.txt'))
        y_copy = np.loadtxt(os.path.abspath('../data/link_prediction/data/y_copy.txt'))
    else:
