    ...
    for src_node in full_G.nodes():
        for dst_node in full_G.nodes():
            if src_node != dst_node:
                basic_info = node_host[src_node] + ' ' + node_layer[src_node] + ' ' + node_type[src_node] + ' ' + \
                             node_host[dst_node] + ' ' + node_layer[dst_node] + ' ' + node_type[dst_node] + ' ' + \
                ...
                if (str(src_node), str(dst_node)) in full_G.edges():
                    ...
                    elif (node_layer[src_node] == 'virus' and node_layer[dst_node] == 'host') or (
                            node_layer[src_node] == 'host' and node_layer[dst_node] == 'virus'):
                        to_add = basic_info + ' infects'
                    elif (node_layer[src_node] == 'virus' and node_layer[dst_node] == 'virus protein') or (
                            node_layer[src_node] == 'virus protein' and node_layer[dst_node] == 'virus'):
                        to_add = basic_info + ' belongs'
                    elif (node_layer[src_node] == 'host' and node_layer[dst_node] == 'host protein') or (
                            node_layer[src_node] == 'host protein' and node_layer[dst_node] == 'host'):
                        to_add = basic_info + ' belongs'
                    elif (node_layer[src_node] == 'host protein' and node_layer[dst_node] == 'virus protein') or (
                            node_layer[src_node] == 'virus protein' and node_layer[dst_node] == 'host protein'):
...
def node_content_emb():
    ...
    for node in full_G.nodes():
        to_add = node_host[node] + ' ' + node_layer[node] + ' ' + node_type[node] + ' ' + protein_function_data[
            node_type[node]]
