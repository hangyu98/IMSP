...
class _LINE(object):
    ...
    def build_graph(self):
        ...
        self.embeddings = tf.Variable(tf.initializers.GlorotUniform(seed=cur_seed)([self.node_size, self.rep_size]),
                                      name="embeddings" + str(self.order))
        self.context_embeddings = tf.Variable(
            tf.initializers.GlorotUniform(seed=cur_seed)([self.node_size, self.rep_size]),
