...
class GCN(object):
    ...
    def build_placeholders(self):
        ...
        self.placeholders = {
            ...
            'features': tf.compat.v1.sparse_placeholder(tf.float32, shape=tf.constant(self.features[2], dtype=tf.int64)),
            'labels': tf.compat.v1.placeholder(tf.float32, shape=(None, self.labels.shape[1])),
